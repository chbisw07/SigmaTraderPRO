...
def test_normalize_angel_exch_seg_handles_cash_aliases() -> None:
    ...
    assert normalize_angel_exch_seg("NSE-CM") == "NSE"
    assert normalize_angel_exch_seg("NSE_CM") == "NSE"
    assert normalize_angel_exch_seg("BSECM") == "BSE"
    assert normalize_angel_exch_seg("BSE-CM") == "BSE"
    assert normalize_angel_exch_seg("BSE_CM") == "BSE"
